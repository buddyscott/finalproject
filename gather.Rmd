...
full_dataset %>%
  ...
  labs(title = "February 2020 Team Valuations", x = "Team", y = "Valuation") + 
  coord_flip() + 
  theme_bw() + 
...
pivoted_dataset %>%
  ...
  labs(title = "Team Valuation Breakdown", x = "Valuation Breakdown", 
       y = "Dollars") +
  scale_x_discrete(breaks = c("brand", "market", "sport", "stadium"), 
                   labels = c("Brand", "Market", "Sport", "Stadium")) + 
  scale_y_continuous(breaks = c(500, 1000, 1500, 2000), 
                     labels = c("$500M", "$1B", "$1.5B", "$2B")) + 
  theme_classic()
