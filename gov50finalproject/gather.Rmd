...
```{r}
atl <- read_csv("raw_data/atlantahawks.csv", col_type = cols(.default = col_double(), 
                                                    name = col_character(), 
...
bos <- read_csv("raw_data/bostonceltics.csv", col_type = cols(.default = col_double(), 
                                                    name = col_character(), 
                                                    position = col_character(), 
                                                    height = col_character(),
                                                    wingspan = col_character(),
...
bkn <- read_csv("raw_data/brooklynnets.csv", col_type = cols(.default = col_double(), 
                                                    name = col_character(), 
                                                    position = col_character(), 
                                                    height = col_character(),
                                                    wingspan = col_character(),
...
cha <- read_csv("raw_data/charlottehornets.csv", col_type = cols(.default = col_double(), 
                                                    name = col_character(), 
                                                    position = col_character(), 
                                                    height = col_character(),
                                                    wingspan = col_character(),
