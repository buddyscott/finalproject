...
```{r}
model_1 <- stan_glm(data = full_dataset, valuation ~ lastseasonwinpct + 
                      gate_receipts + wins_to_player + revenue_per_fan + 
                      tenyrwinpct + debt_to_value + revenue + operating_income,
